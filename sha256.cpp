...
std::string sha256(const std::string &input, unsigned int &digest_length)
{
...
int main()
{
    ...
    for (int i = 0; i < NUM_TESTS; ++i)
    {
        ...
        std::string hash = sha256(input, digest_length);
